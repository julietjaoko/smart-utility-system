    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('PROPERTY_MANAGER', 'Property Manager'), ('TENANT', 'Tenant')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.propertymanager')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('meter_type', models.CharField(choices=[('WATER', 'Water'), ('ELECTRICITY', 'Electricity')], max_length=15)),
